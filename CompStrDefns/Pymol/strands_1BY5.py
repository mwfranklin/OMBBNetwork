...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/1BY5.pdb")
...
cmd.select("Astrand10", "resi 444-463 & chain A ")
cmd.color ("orange", "Astrand10")


cmd.select("Astrand11", "resi 469-485 & chain A ")
...
cmd.select("Astrand17", "resi 611-622 & chain A ")
cmd.color ("orange", "Astrand17")


cmd.select("Astrand18", "resi 630-644 & chain A ")
