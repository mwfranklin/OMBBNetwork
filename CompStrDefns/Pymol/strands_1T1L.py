...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/1T1L.pdb")
...
cmd.select("Astrand3", "resi 120-136 & chain A ")
cmd.color ("purple", "Astrand3")


cmd.select("Astrand4", "resi 140-159 & chain A ")
