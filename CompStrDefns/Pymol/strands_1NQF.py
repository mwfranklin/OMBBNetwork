...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/1NQF.pdb")
cmd.hide("everything", "all")
cmd.color("wheat","all")
cmd.select("Astrand0", "resi 139-145 & chain A ")
...
cmd.select("Astrand2", "resi 163-174 & chain A ")
cmd.color ("orange", "Astrand2")


cmd.select("Astrand3", "resi 198-209 & chain A ")
...
cmd.select("Astrand7", "resi 291-304 & chain A ")
...
cmd.select("Astrand11", "resi 366-379 & chain A ")
...
cmd.select("Astrand17", "resi 500-508 & chain A ")
...
cmd.select("Astrand20", "resi 559-566 & chain A ")
