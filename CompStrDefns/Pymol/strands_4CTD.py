...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/4CTD.pdb")
cmd.hide("everything", "all")
cmd.color("wheat","all")
cmd.select("Astrand0", "resi 7-18 & chain A ")
...
cmd.select("Astrand7", "resi 147-161 & chain A ")
...
cmd.select("Astrand10", "resi 203-215 & chain A ")
cmd.color ("orange", "Astrand10")


cmd.select("Astrand11", "resi 221-231 & chain A ")
cmd.color ("yellow", "Astrand11")


cmd.select("Astrand12", "resi 235-246 & chain A ")
cmd.color ("green", "Astrand12")


cmd.select("Astrand13", "resi 257-268 & chain A ")
