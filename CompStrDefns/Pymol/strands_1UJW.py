...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/1UJW.pdb")
...
cmd.select("Astrand17", "resi 497-508 & chain A ")
...
cmd.select("Astrand19", "resi 541-555 & chain A ")
