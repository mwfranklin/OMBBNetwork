...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/3RBH.pdb")
cmd.hide("everything", "all")
cmd.color("wheat","all")
cmd.select("Astrand0", "resi 43-53 & chain A ")
...
cmd.select("Astrand10", "resi 273-287 & chain A ")
cmd.color ("orange", "Astrand10")


cmd.select("Astrand11", "resi 303-320 & chain A ")
...
cmd.select("Astrand13", "resi 376-388 & chain A ")
...
cmd.select("Astrand16", "resi 456-466 & chain A ")
cmd.color ("red", "Astrand16")


cmd.select("Astrand17", "resi 481-490 & chain A ")
