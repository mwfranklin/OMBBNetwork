...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/3M8D.pdb")
...
cmd.select("Astrand2", "resi 163-178 & chain A ")
cmd.color ("orange", "Astrand2")


cmd.select("Astrand3", "resi 188-209 & chain A ")
cmd.color ("purple", "Astrand3")


cmd.select("Astrand4", "resi 213-233 & chain A ")
