...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/1PO3.pdb")
cmd.hide("everything", "all")
cmd.color("wheat","all")
cmd.select("Astrand0", "resi 222-232 & chain A ")
cmd.color ("white", "Astrand0")


cmd.select("Astrand1", "resi 243-254 & chain A ")
cmd.color ("red", "Astrand1")


cmd.select("Astrand2", "resi 257-269 & chain A ")
...
cmd.select("Astrand15", "resi 581-593 & chain A ")
