...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/3HWB.pdb")
...
cmd.select("Astrand6", "resi 148-161 & chain A ")
...
cmd.select("Astrand11", "resi 247-265 & chain A ")
cmd.color ("yellow", "Astrand11")


cmd.select("Astrand12", "resi 269-281 & chain A ")
