...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/3SLO.pdb")
...
cmd.select("Astrand3", "resi 1095-1112 & chain A ")
cmd.color ("purple", "Astrand3")


cmd.select("Astrand4", "resi 1118-1135 & chain A ")
