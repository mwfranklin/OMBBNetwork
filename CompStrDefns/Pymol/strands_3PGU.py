...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/3PGU.pdb")
...
cmd.select("Astrand6", "resi 221-235 & chain A ")
cmd.color ("cyan", "Astrand6")


cmd.select("Astrand7", "resi 267-283 & chain A ")
cmd.color ("blue", "Astrand7")


cmd.select("Astrand8", "resi 287-307 & chain A ")
cmd.color ("purple", "Astrand8")


cmd.select("Astrand9", "resi 314-335 & chain A ")
