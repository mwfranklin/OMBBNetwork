...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/1NQE.pdb")
...
cmd.select("Astrand1", "resi 147-158 & chain A ")
cmd.color ("red", "Astrand1")


cmd.select("Astrand2", "resi 164-176 & chain A ")
cmd.color ("orange", "Astrand2")


cmd.select("Astrand3", "resi 196-208 & chain A ")
...
cmd.select("Astrand20", "resi 558-567 & chain A ")
