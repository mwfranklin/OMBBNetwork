...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/1NQG.pdb")
...
cmd.select("Astrand4", "resi 213-226 & chain A ")
...
cmd.select("Astrand19", "resi 537-553 & chain A ")
