...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/2W77.pdb")
...
cmd.select("Astrand10", "resi 543-559 & chain A ")
...
cmd.select("Astrand14", "resi 629-645 & chain A ")
...
cmd.select("Astrand16", "resi 684-698 & chain A ")
