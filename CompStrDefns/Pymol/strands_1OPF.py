...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/1OPF.pdb")
cmd.hide("everything", "all")
cmd.color("wheat","all")
cmd.select("Astrand0", "resi 10-20 & chain A ")
cmd.color ("white", "Astrand0")


cmd.select("Astrand1", "resi 38-49 & chain A ")
...
cmd.select("Astrand10", "resi 226-242 & chain A ")
cmd.color ("orange", "Astrand10")


cmd.select("Astrand11", "resi 246-262 & chain A ")
