...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/4AZL.pdb")
...
cmd.select("Astrand11", "resi 300-318 & chain A ")
...
cmd.select("Astrand14", "resi 392-402 & chain A ")
cmd.color ("blue", "Astrand14")


cmd.select("Astrand15", "resi 426-436 & chain A ")
