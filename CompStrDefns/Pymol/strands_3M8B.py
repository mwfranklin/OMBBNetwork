...
cmd.load("/Users/meghan/Documents/PhD/GitProjects/v6_2018_Network/CompStrDefns/CompPDBs/3M8B.pdb")
...
cmd.select("Astrand2", "resi 163-176 & chain A ")
...
cmd.select("Astrand20", "resi 558-573 & chain A ")
cmd.color ("cyan", "Astrand20")


cmd.select("Astrand21", "resi 581-593 & chain A ")
